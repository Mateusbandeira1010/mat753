...
app.post('/atualizar-valor-restante', (req, res) => {
  ...
  // Aqui você executa a lógica para atualizar o valor restante no banco de dados
  // por exemplo, usando o clienteId e valorRestante para atualizar o registro do cliente no banco de dados
});
